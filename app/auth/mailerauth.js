...
export async function sendConfirmationEmail(user, confirmationCode) {
    let oauth2Client = new google.auth.OAuth2(
        process.env.CLIENT_ID,
        process.env.CLIENT_SECRET,
        "https://developers.google.com/oauthplayground" // Este es el redirect URL que se utiliza en el OAuth Playground
    );
    ...
    let mailOptions = {
        ...
        0; color: #2D444E; font-family: 'Gotham',Helvetica,Arial,sans-serif; font-size: 25px; font-weight: normal; line-height: 1.3; margin: 0 !important; padding: 0;">Hola Amdin el ${user.nombre} quiere trabajar</p><br/><br/>
